...
void WalletTxToJSON(const CWalletTx& wtx, Object& entry)
{
    ...
    entry.push_back(Pair("tx-comment", wtx.strmessages));
...
Value sendmany(const Array& params, bool fHelp)
{
    ...
    bool fCreated = pwalletMain->CreateTransaction(vecSend, wtx, keyChange, nFeeRequired, strmessages);
    if (!fCreated)
    {
