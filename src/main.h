...
static const int64_t MAX_MONEY = 30000100000 * COIN;
static const int64_t COIN_YEAR_REWARD = 0.1 * CENT; // 1% per year
...
public:
    ...
    std::string ToString() const
    {
        ...
        str += strprintf("(hash=%s, nTime=%d, ver=%d, vin.size=%"PRIszu", vout.size=%"PRIszu", nLockTime=%d, strMERCURYSpeech=%s)\n",
            ...
            vout.size(),
            nLockTime,
            strMERCURYSpeech.substr(0,30).c_str());
