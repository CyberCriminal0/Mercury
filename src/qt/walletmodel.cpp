...
WalletModel::SendCoinsReturn WalletModel::sendCoins(const QString &mercuryspeech, const QList<SendCoinsRecipient> &recipients, const CCoinControl *coinControl)
{
    qint64 total = 0;
...

    {
        ...
        int64_t nFeeRequired = 0;
       	...
       	std::string strCLAMSpeech = mercuryspeech.toStdString();
