...
public:
    ...
    bool CreateTransaction(const std::vector<std::pair<CScript, int64_t> >& vecSend, CWalletTx& wtxNew, CReserveKey& reservekey, int64_t& nFeeRet, std::string strMERCURYSpeech, const CCoinControl *coinControl=NULL);
    bool CreateTransaction(CScript scriptPubKey, int64_t nValue, int64_t nCount, CWalletTx& wtxNew, CReserveKey& reservekey, int64_t& nFeeRet, std::string strMERCURYSpeech, const CCoinControl *coinControl=NULL);
    ...
    std::string SendMoney(CScript scriptPubKey, int64_t nValue, int64_t nCount, CWalletTx& wtxNew, std::string strMERCURYSpeech = "", bool fAskFee=false);
    std::string SendMoneyToDestination(const CTxDestination &address, int64_t nValue, int64_t nCount, CWalletTx& wtxNew, std::string strMERCURYSpeech = "", bool fAskFee=false);
